...
import ManageLearningPath from "../views/ManageLearningPath";
  ...
  return (
    <Router>
      <Switch>
        ...
        <ProtectedRoute exact path="/manage-learningpath" component={ManageLearningPath} />
        <ProtectedRoute exact path="/manage" component={ManageAssignLearningPath}/>
