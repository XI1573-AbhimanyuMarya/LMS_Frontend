...
const getAssignedLearningPath = (managerEmail) => ({ type: actionTypes.GET_ASSIGNED_LEARNING_PATH_REQUEST, payload: { managerEmail } })
const getMyLearningPath = (employeeEmail) => ({ type: actionTypes.GET_MY_LEARNING_PATH_REQUEST, payload: { employeeEmail } })
